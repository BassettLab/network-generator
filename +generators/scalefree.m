...
%           distribution.
%       beta (float) Probability for adding an edge between two existing 
...
%       gamma (float) Probability for adding a new node connected to an 
%           existing node chosen randomly according to the out-degree 
%           distribution.
%       delta_in (float) Bias for choosing ndoes from in-degree 
%           distribution.
